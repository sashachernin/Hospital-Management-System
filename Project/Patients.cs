...
namespace Project
{
    public partial class Patients : UserControl
    {
        ...
        private void ListUpdate()
        {
            ...
            patientGrid_RowStateChanged(null,null);
        ...
        private void Patients_Load(object sender, EventArgs e)
        {
            ...
            this.cmbRoomNumber.DropDownStyle = ComboBoxStyle.DropDownList;
            this.cmbBedNumber.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private void ok_button_Click(object sender, EventArgs e)//when OK clicked = two options. OK after EDIT or OK after NEW 
        {
            ...
            if (((name_box.Text == "") || (lastname_box.Text == "") || (Cmb_Gender.Text == "") || (email_box.Text == "") || (id_box.Text == "") || (phone_box.Text == "") || (cmbRoomNumber.Text == "") || (cmbBedNumber.Text == "") || (diagnosis_box.Text == "") || (checkInDateBox.Text == ""))&&(patientGrid.SelectedRows[0].Cells[7].Value == null))
            {
            ...
            else if ((Rooms.isBedTaken(cmbRoomNumber.Text, cmbBedNumber.Text)&&(previousBed!= patientGrid.SelectedRows[0].Cells[8].Value.ToString()))&&(previousRoom != patientGrid.SelectedRows[0].Cells[9].Value.ToString()))//בדיקה האם המיטה תפוסה
            {
        ...
        private void editBtn_Click(object sender, EventArgs e)
        {
            ...
            if (rechecking == true) //edit panel is used for editing and rechecking. this is the recheck case
            {
                ...
                cmbBedNumber.Text = "1";//default
                cmbRoomNumber.Text = "1";//default
                cmbRoomNumber.Enabled = true; 
                cmbBedNumber.Enabled = true;
            ...
            else
            {
                ...
                //test
                cmbRoomNumber.Enabled = false; cmbBedNumber.Enabled = false;
                previousBed = patientGrid.SelectedRows[0].Cells[8].Value.ToString();
                previousRoom = patientGrid.SelectedRows[0].Cells[9].Value.ToString();
                
                    
                if (patientGrid.SelectedRows[0].Cells[7].Value != null)
                {
                    cmbBedNumber.Text = null; cmbRoomNumber.Text = null;
        ...
        private void checkOutBtn_Click(object sender, EventArgs e)
        {
            ...
            patientGrid.SelectedCells[8].Value = ""; 
            patientGrid.SelectedCells[9].Value = ""; 
        ...
        private void patientGrid_RowStateChanged(object sender, DataGridViewRowStateChangedEventArgs e)
        {
            ...
            //recheck button
            if ((patientGrid.SelectedRows.Count > 0) && (patientGrid.SelectedCells[7].Value != null)&&(panel_is_opened==false))
                reCheckBtn.Enabled = true;
            else
                reCheckBtn.Enabled = false;
